...
export type SpeciesRead = components['schemas']['SpeciesRead'];
export type SpeciesListItem = components['schemas']['SpeciesListItem'];
...
export type SeasonInfo = components['schemas']['SeasonInfo'];
export type SeasonPreset = components['schemas']['SeasonPreset'];
export type SeasonPlanApplied = components['schemas']['SeasonPlanApplied'];
