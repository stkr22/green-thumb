...
# registered above take precedence. The index.html fallback only applies to
# requests that accept HTML, so a deep link like /plants/123 resolves to the SPA
# shell while a stale asset or an unknown /api path still gets a real 404.
